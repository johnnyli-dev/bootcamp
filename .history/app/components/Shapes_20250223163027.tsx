...
export function RedCircle() {
	...
	return (
		<svg
			className="our-circle absolute top-[-400%] left-[-15%] -translate-x-1/2 -translate-y-1/2 w-[35vw] h-[35vw]"
			viewBox="0 0 256 256"
			style={{
...
export function YellowHexagon() {
	...
	return (
		<div
			className="our-hexagon absolute top-[-20%] right-[-20%] translate-x-1/2 -translate-y-1/2 w-[40vw] h-[40vw]"
			style={{
				transform: `rotate(${-rotation}deg)`,
				WebkitTransform: `rotate(${-rotation}deg)`,
				MozTransform: `rotate(${-rotation}deg)`,
